...
export const STRATAGEMS: Stratagem[] = [
    { name: 'Reinforce', sequence: ['UP', 'DOWN', 'RIGHT', 'LEFT', 'UP'], icon: '/icons/Reinforce.png' },
    { name: 'Resupply', sequence: ['DOWN', 'DOWN', 'UP', 'RIGHT'], icon: '/icons/Resupply.png' },
    { name: 'Eagle Airstrike', sequence: ['UP', 'RIGHT', 'DOWN', 'RIGHT'], icon: '/icons/Eagle Airstrike.png' },
    { name: 'Hellbomb', sequence: ['DOWN', 'UP', 'LEFT', 'DOWN', 'UP', 'RIGHT', 'DOWN', 'UP'], icon: '/icons/Hellbomb.png' },
    { name: 'SOS Beacon', sequence: ['UP', 'DOWN', 'RIGHT', 'UP'], icon: '/icons/SOS Beacon.png' },
    { name: 'Railgun', sequence: ['DOWN', 'RIGHT', 'DOWN', 'UP', 'LEFT', 'RIGHT'], icon: '/icons/Railgun.png' },
    ...
    { name: 'Orbital 120MM Barrage', sequence: ['RIGHT', 'RIGHT', 'DOWN', 'LEFT', 'RIGHT', 'DOWN'], icon: '/icons/120MM.png' },
    { name: 'Autocannon', sequence: ['DOWN', 'LEFT', 'DOWN', 'UP', 'UP', 'RIGHT'], icon: '/icons/Autocannon.png' },
    { name: 'M-102 Fast Recon vehicle', sequence: ['LEFT', 'DOWN', 'RIGHT', 'UP', 'LEFT', 'DOWN', 'DOWN'], icon: '/icons/Car.png' },
    { name: 'Orbital Gas Strike', sequence: ['RIGHT', 'RIGHT', 'DOWN', 'RIGHT'], icon: '/icons/Gas Strike.png' },
    { name: 'Machine Gun Sentry', sequence: ['DOWN', 'UP', 'RIGHT', 'RIGHT', 'UP'], icon: '/icons/Gatling.png' },
    { name: 'LIFT-850 Jump Pack', sequence: ['DOWN', 'UP', 'UP', 'DOWN', 'UP'], icon: '/icons/Jump.png' },
    { name: 'ARC-3 Tesla Tower', sequence: ['DOWN', 'UP', 'RIGHT', 'UP', 'LEFT', 'RIGHT'], icon: '/icons/Tesla Tower.png' },

    // New Stratagems
    { name: 'Super Earth Flag', sequence: ['DOWN', 'UP', 'DOWN', 'UP'], icon: '/icons/Superflag.png' },
    { name: 'GR-8 Recoilless Rifle', sequence: ['DOWN', 'LEFT', 'RIGHT', 'RIGHT', 'LEFT'], icon: '/icons/Recoil.png' },
    { name: 'GL-21 Grenade Launcher', sequence: ['DOWN', 'LEFT', 'UP', 'LEFT', 'DOWN'], icon: '/icons/Grenade.png' },
    ...
    { name: 'Orbital 380MM HE Barrage', sequence: ['RIGHT', 'DOWN', 'UP', 'UP', 'LEFT', 'DOWN', 'DOWN'], icon: '/icons/380MM.png' },
